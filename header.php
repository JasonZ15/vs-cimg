...
<body <?php body_class(); ?>>
	...
	<div id="container">
		...
		<header id="header" class="clearfix">
			...
			<a style="clear:left; margin-top: 0;" href="http://www.gmic-sv.com/receive-updates/" target="_blank" id="email-list" class="action-button" target="_blank"><span class="color"><span class="text"><?php esc_html_e( 'Get GMIC SV Email Updates', 'Flexible' ); ?></span></span></a>
