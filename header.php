...
<body <?php body_class(); ?>>
	<div id="container">
		...
		<header id="header" class="clearfix">
			...
			<a style="margin-left:5px;" href="http://www.gmic-sv.com/?page_id=290" id="sponsor" class="action-button"><span class="color"><span class="text"><?php esc_html_e( 'Promote Your Company at GMIC SV', 'Flexible' ); ?></span></span></a>
			<a style="clear:left; margin-top: 0;" href="http://eepurl.com/h2MOg" id="email-list" class="action-button" target="_blank"><span class="color"><span class="text"><?php esc_html_e( 'Get GMIC SV Email Updates', 'Flexible' ); ?></span></span></a>
